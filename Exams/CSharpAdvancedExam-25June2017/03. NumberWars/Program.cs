...
namespace _03._NumberWars
{
    class Program
    {
        ...
        private static int GetCharValue(string letter)
        {
            return letter.Last();
        }

        private static int GetNumberValue(string currentCard)
        {
            return int.Parse(currentCard.Substring(0, currentCard.Length - 1));
        }
